...
public class Main {
	...
	public static String setColorAndGetColorName(Shape shape, String name, Color value) {
		...
		try {
			Method method1 = clazz.getDeclaredMethod(setterName, clazz.getDeclaredField(fieldName).getType());
			method1.setAccessible(true);
			method1.invoke(shape, value);
			
			
			Method method2 = clazz.getDeclaredMethod(getterName);
			fieldName = (String) method2.invoke(shape);			
